...
import 'package:hackathon/utilities/StartupCard.dart';
...
class StartupList extends StatefulWidget {
  @override
  _StartupListState createState() => _StartupListState();
}
      ...
      body:  Column(
        children: <Widget>[
          ...
          StreamBuilder(
            ...
            //this line needs to take in startup collection instead of investors
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        DocumentSnapshot ds = snapshot.data.documents[index];
                         ...
                         Startup stp = Startup(url: ds["url"],
                            name: ds["name"],
                        ...
                        return StartupCard(startup: stp);
                        //return Text(ds['name']);
                      }
